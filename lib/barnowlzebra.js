...
const ZebraDecoder = require('./zebradecoder.js');
...
/**
 * BarnowlZebra Class
 * Converts Zebra reader data into standard raddec events.
 * @param {Object} options The options as a JSON object.
 */
class BarnowlZebra extends EventEmitter {

  /**
   * BarnowlZebra constructor
   * @param {Object} options The options as a JSON object.
   * @constructor
   */
  constructor(options) {
    ...
    this.listeners = [];
    this.zebraDecoder = new ZebraDecoder({ barnowl: this });
  }
  ...
  addListener(ListenerClass, options) {
    options = options || {};
    options.decoder = this.zebraDecoder;
